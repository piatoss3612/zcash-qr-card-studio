...
- **QR design** — with the QR layer selected: module shape (square / rounded / dots, finder eyes stay solid), module colour (ink, indigo, forest, crimson or custom; preflight warns below 4:1 contrast) and a centre emblem (none, Vizorcat, Vizor mark, Zcash). Defaults: Zcash on payment cards, the Vizor mark on gift cards, Vizorcat on link cards. Any emblem switches the code to error-correction level H and covers about 8% of it.
