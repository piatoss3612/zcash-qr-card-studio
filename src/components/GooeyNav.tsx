/* Rare UI registry component: Gooey Nav.
 * Source: https://github.com/swamimalode07/rare-ui/tree/main/components/ui
 * App adaptation: the Next.js route adapter is replaced with local <a>/<button> items.
 */
import {
  useEffect,
  useId,
